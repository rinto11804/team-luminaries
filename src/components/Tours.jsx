...
const planets = [
  {
    ...
    description:
      "Mars is the second smallest planet in the Solar System - only Mercury is smaller.",
  },
  {
    id: 2,
    name: "Jupiter",
    imageSrc:
      "https://api.time.com/wp-content/uploads/2022/09/jupiter-china-spacecraft.jpg?quality=85&w=800",
  ...
  },
  {
    ...
    name: "Neptune",
    imageSrc:
      "https://wallpapers.com/images/high/neptune-on-black-533l3zznbxf1wdty.webp",
    imageAlt: "Neptune",
    description:
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {planets.map((planet) => (
            <a href="#5">
              <div
                key={planet.id}
                className="group relative shadow-xl p-10 hover-2 "
              >
                  ...
                  <div className="text-center w-full">
                    <h3 className="text-lg font-semibold text-gray-700 ">
                      <a href={planet.href} className="flex flex-col gap-3">
                        ...
                        <p className="font-Nlight text-[15px]">
                          {planet.description}
                        </p>
                      </a>
                    </h3>
